...
export async function POST(request: NextRequest) {
  try {
    ...
    const targetUrl = `${backendUrl}/fund-extraction-agent`;
    
    console.log('🔍 Proxying streaming request to:', targetUrl);
    ...
    console.log('✅ Backend streaming response received, starting proxy...');
